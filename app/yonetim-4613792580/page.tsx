                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="text-center space-y-3">
                                <Link
                                    ...
                                    className="text-zinc-500 hover:text-red-600 text-xs font-medium transition-colors block"
                                >
                                    Şifremi Unuttum
                                </Link>
                                <a
                                    href="https://www.basketbolkoordinasyonsistemi.com.tr/"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="flex items-center justify-center gap-2 w-full bg-zinc-800 hover:bg-zinc-700 text-zinc-300 hover:text-white font-medium py-3 rounded-xl transition-all text-sm border border-zinc-700"
                                >
