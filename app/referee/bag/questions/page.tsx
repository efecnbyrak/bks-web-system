            ...
            {step === 0 && (
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-5xl mx-auto">
                    <div className="text-center mb-12">
                        <h1 className="text-4xl font-black text-zinc-900 dark:text-white mb-4 italic uppercase tracking-tight">Kategori Seçimi</h1>
            ...
            {step === 1 && (
                <div className="animate-in fade-in zoom-in-95 duration-300 max-w-5xl mx-auto">
                    <div className="text-center mb-10">
                        <h1 className="text-4xl font-black text-zinc-900 dark:text-white mb-4 italic uppercase tracking-tight">Kategori Seçimi</h1>
                        <p className="text-zinc-500 font-medium tracking-widest uppercase text-xs">Hangi kategoriyi çalışmak istersiniz?</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {CATEGORIES.map(cat => (
                            <button
                                ...
                                className="group p-6 bg-white dark:bg-zinc-900 border-2 border-zinc-200 dark:border-zinc-800 rounded-2xl hover:border-red-500 hover:shadow-xl transition-all text-left"
                            >
                                <span className="font-bold text-zinc-800 dark:text-zinc-100 group-hover:text-red-600 transition-colors">{cat}</span>
                            </button>
                        ))}
                    </div>
                </div>
